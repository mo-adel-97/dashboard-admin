...
export default function PrimarySearchAppBar() {
  ...
  return (
    <Box sx={{ flexGrow: 1}}>
      <AppBar style={{width:'calc(100% - 200px)',backgroundColor:theme === "dark" ? '#2f2f2f' : 'white' }}>
        <Toolbar > 
          <Search style={{width:"60%",marginLeft:"2rem",border:theme === "dark" ? '1px solid white' : '1px solid gray'}}>
            <SearchIconWrapper style={{paddingLeft:"1rem"}}>
